...
// 热门博客分页列表
export const queryPageBlog = (params) => ajax(BASE_URL + '/iwork/httpservice/queryPageBlog', params, 'GET');
...
export const RecordAdvstAccessLog = (params) => ajax(BASE_URL + '/iwork/httpservice/RecordAdvstAccessLog', params, 'GET');
export const GetAdvstAccessLog = (params) => ajax(BASE_URL + '/iwork/httpservice/GetAdvstAccessLog', params, 'GET');
...
export const QueryResume = (params) => ajax(BASE_URL + '/iwork/httpservice/QueryResume', params, "POST");
