...
func Test_SFTPConnectTest(t *testing.T) {
	...
	var localFilePath = "D:/zhourui/program/go/goland_workspace/src/isoft_utils/isoft_deploy_web/shell/common/port_check.sh"
...
func Test_SFTPDirectoryCopy(t *testing.T) {
	// 用来测试的本地文件路径 和 远程机器上的文件夹
	var localDirectoryPath = "D:/zhourui/program/go/goland_workspace/src/isoft_utils/isoft_deploy_web/shell"
	var remoteDir = "/mydata/deploy_home"
