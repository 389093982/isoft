...
func (this *WorkSubNode) RunOnceSubWork(work_id int64, trackingId string,
	...
	trackingId, receiver := this.WorkSubRunFunc(work_id,
		&entry.Dispatcher{TrackingId: trackingId, TmpDataMap: tmpDataMap, TxManger: this.DataStore.TxManger, ExistParentWork: true})
	// 接收子流程数据存入 dataStore
