  ...
  <div style="background: #FFFFFF;padding: 10px;">
    <Row>
      ...
      <Col v-else span="16" style="padding:50px;">
        ...
        <IBeautifulLink font-weight="bold" @onclick="$router.push({path:'/ilearning/index'})">试试找找其它资源</IBeautifulLink>
      </Col>
      <Col span="8">
...
<script>
  ...
  export default {
    name: "CourseSearch",
    components: {RandomAdmt, IBeautifulLink, CourseMeta, SiteDashBoard},
    data() {
      return {
        courses: [],
      }
