...
class CustomTagCourseResponse {
  List<CustomTagCourse> customTagCourses;
  String errorMsg;
  Paginator paginator;
  String status;

  CustomTagCourseResponse(
      {this.customTagCourses, this.errorMsg, this.paginator, this.status});

  CustomTagCourseResponse.fromJson(Map<String, dynamic> json) {
    if (json['custom_tag_courses'] != null) {
      customTagCourses = new List<CustomTagCourse>();
      json['custom_tag_courses'].forEach((v) {
        customTagCourses.add(new CustomTagCourse.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.customTagCourses != null) {
      data['custom_tag_courses'] =
          this.customTagCourses.map((v) => v.toJson()).toList();
    }
...
class CustomTagCourse {
  ...
  CustomTagCourse.fromJson(Map<String, dynamic> json) {
