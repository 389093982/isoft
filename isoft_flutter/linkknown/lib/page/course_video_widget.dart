                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Expanded(child: Text(""),),
                      SvgPicture.asset("images/ic_clock.svg", width: 15, height: 15, fit: BoxFit.fill, color: Colors.grey[800],),
                      Text("${CommonUtil.formateDuration(widget.cVideos[index].duration)}", style: TextStyle(color: Colors.grey[800], fontSize: 12),),
                    ],
                  ),
                ),
